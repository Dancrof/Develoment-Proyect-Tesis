...
Puede ingresar el número de días de registros de base de datos que se eliminarán y el historial de notificaciones se eliminará desde el día especificado.',
    ...
    'type_your_search_term_here' => 'Escribe tu búsqueda aquí...',
    'search' => 'Buscar',
    'you_are_here' => 'Estás aquí',
    'hello' => 'Hola',
    'pages' => 'Páginas',
    ...
    */
    ...
    'customize_system_appearance'    => 'Personaliza la apariencia de tu sistema',
    'admin_agent_panel_logo'        => 'Logo del Panel de Administración y Agentes',
    'recommended'                   => 'Recomendado',
    'upload_panel_logo'            => 'Subir Logo del Panel',
    'use_logo_instead_name'        => 'Usar logo en lugar del nombre de la compañía',
    'logo_header_info'             => 'Si está activado, el logo se mostrará en lugar del nombre en el encabezado',
    'use_default_panel_logo'       => 'Usar Logo del Panel por defecto',
    'favicon'                      => 'Favicon',
    'upload_favicon'               => 'Subir Favicon',
    'use_default_favicon'          => 'Usar Favicon por defecto',
    'client_panel_logo'           => 'Logo del Panel de Cliente',
    'upload_client_logo'          => 'Subir Logo del Panel de Cliente',
    'use_client_logo'             => 'Usar logo personalizado en el panel de cliente',
    'client_logo_info'            => 'Si está desactivado, se mostrará el nombre del sistema en lugar del logo',
    'use_default_client_logo'     => 'Usar Logo del Panel de Cliente por defecto',
];
